...
// Formatting controls only. Document actions (Save draft, split/preview) live in the
// status bar, and code-block language/filename live in the contextual side inspector —
// the toolbar deliberately does not duplicate them.
